...
export const openStripeChekoutPage = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      line_items,
      mode: "payment",
      success_url: `https://e-store-fullstack-app-oit8.onrender.com/#/cart?success=true`,
      cancel_url: `https://e-store-fullstack-app-oit8.onrender.com/#/cart?success=false`,
    });
